# dato — instrucciones para Codex

## Triggers — cuando aplicar estas instrucciones

Aplicar cuando el usuario pida: datos oficiales, estadísticas argentinas, datos INDEC, resultados electorales, datos catastrales, jurisprudencia, información pública, series de tiempo, indicadores económicos.
